...
const SimpleLightbox = ({
  ...
  if (!src) return null;
  return <div className="fixed inset-0 z-[60] bg-black/90 flex items-center justify-center p-4 animate-in fade-in duration-200" onClick={onClose}>
...
const ReferenssitSection = () => {
  ...
  return <section id="referenssit" className="py-32 px-6 bg-black border-t border-neutral-800">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {referenceItems.map(item => <div key={item.id} className="group relative overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-900/50 hover:border-heading/50 transition-all duration-500 cursor-pointer" onClick={() => setLightboxImage(item.image)}>
